...
window.Feedback = function( options ) {
    ...
    // default properties
    options.label = options.label || "Report bug";
    options.header = options.header || "Report bug";
    ...
    options.messageSuccess = options.messageSuccess || "Your bug was sent succesfully.";
    options.messageError = options.messageError || "There was an error sending your bug to the server.";
...
window.Feedback.Screenshot.prototype.render = function() {
    ...
    if ( window.html2canvas === undefined && script === undefined ) {
        ...
        script.src = options.h2cPath || "js/html2canvas.js";
